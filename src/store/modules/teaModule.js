		...
		return {
			teaData: [
...

				{
					...
					notes:
						'Unlike most fruit-blend teas where the fruit and sweetness tend to overpower the tea, the Yabukita tea is dominant here. The strawberry pieces impart a fruity, mellow tartness that complements the sweet grain qualities of the tea, giving the tea overall more body and character. The small pieces of fruit also add visual impact, providing bold pops of color against the dark blue-green strands of tea leaves.',
					price: 1829,
					currency: '¥',
					weight: '30 grams',
					imageFiles: [
					...
					chartData: [
						...
						{ label: 'Full-Bodied', value: 5 },
						{ label: 'Roasting', value: 1 },
						{ label: 'Bitterness', value: 3 },
						{ label: 'Fruit', value: 4 },
						{ label: 'Flower', value: 2 },
						{ label: 'Fragrance', value: 3 },
						{ label: 'Earthiness', value: 1 },
						{ label: 'Grassiness', value: 2 },
					],
				},
